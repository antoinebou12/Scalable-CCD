...
__device__ stq::gpu::Scalar3
operator+(const stq::gpu::Scalar3& a, const stq::gpu::Scalar3& b)
{
    return stq::gpu::make_Scalar3(
...
__device__ stq::gpu::Scalar3
__fdividef(const stq::gpu::Scalar3& a, const stq::gpu::Scalar b)
{
    return stq::gpu::make_Scalar3(
...
__device__ stq::gpu::Scalar3
__powf(const stq::gpu::Scalar3& a, const stq::gpu::Scalar b)
{
    return stq::gpu::make_Scalar3(
        __powf(a.x, b), __powf(a.y, b), __powf(a.z, b));
}
